  ...
  return (
    <div className={classes.root}>
      <Grid container justify='center' className={classes.gridContiner}>
        ...
        <Grid item xs={12} sm={6} md={3} className={classes.form}>
        <div id = 'form'>
        <form onSubmit={handleSubmit}>
        
        <p style={{textAlign:'center', color:'whitesmoke',cursor:'default'}}> Sign in to share your memories</p>
        <input type="email" id="fname" name="firstname" placeholder="Email" onChange={handleChangeEmail} />

        <input type="password" id="lname" name="lastname" placeholder="Password" onChange={handleChangePassword} />
